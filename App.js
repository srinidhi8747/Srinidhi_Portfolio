        ...
        <section className="hero" id="about">
          <div className="hero-content">
            ...
            <div className="btn-group">
              ...
              <a href="Resume/Srinidhi.pdf" target="_blank" rel="noopener noreferrer" download className="btn btn-secondary"><i class="fa-solid fa-download"></i> Download Resume</a>
            </div>
          </div>
